---
version: alpha
name: qieman-design-report
title: qieman report ppt design
license: Complete terms in LICENSE.txt
description: >-
  Qieman wealth advisory report slides (HTML 16:9, 720pt×405pt) for PPT/PDF export:
  light-blue canvas, borderless white cards, restrained charts, header/footer rhythm.
  Use for account reviews, goal planning, asset allocation decks, and advisor client reports.
layer: L2
...
# qieman report ppt design

| 项 | 说明 |
|---|---|
| **Skill ID** | `qieman-design-report` |
| **层级** | L2 场景层（HTML 16:9 投顾报告幻灯片） |
| **完整规范** | 本文件 `SKILL.md` |
...
qieman report ppt design（本文件 `SKILL.md`）是一套 **PPT 还原优先** 的 HTML 报告设计语言，服务于账户诊断、周/月度复盘、财富目标规划、资产配置建议、投顾策略说明和高净值客户报告。它不是营销 H5，也不是后台数据看板，而是面向客户阅读与顾问讲解的 16:9 报告页。
...
使用 qieman report ppt design skill 生成以下类型的 HTML 幻灯片：
