...
qieman report slides design（本文件 `SKILL.md`）是一套 **PPT 还原优先** 的 HTML 报告设计语言，服务于账户诊断、周/月度复盘、财富目标规划、资产配置建议、投顾策略说明和高净值客户报告。它不是营销 H5，也不是后台数据看板，而是面向客户阅读与顾问讲解的 16:9 报告页。
