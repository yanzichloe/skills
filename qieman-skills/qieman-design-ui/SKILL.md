...
| **层级** | L0 基础层 |
| **完整规范** | 本文件 `SKILL.md` |
| **L1 扩展** | [qieman-sell-popup-design.md](./references/qieman-sell-popup-design.md) |
...
| spec-id | 文件 | 适用任务 |
|---------|------|----------|
| `qieman-sell-popup-design` | [qieman-sell-popup-design.md](./references/qieman-sell-popup-design.md) | App 内 **卖出 / 赎回 / 退出策略** 底部全宽挽留弹窗（375×812、无关闭按钮、主题渐变） |
...
- **底部挽留 / 卖出确认弹窗** → 使用 L1 扩展 [qieman-sell-popup-design.md](./references/qieman-sell-popup-design.md)，不要仅在 L0 临时拼凑弹窗样式。
